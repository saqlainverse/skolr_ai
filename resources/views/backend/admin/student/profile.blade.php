            ...
            <div class="col-lg-12">
                <div class="bg-white redious-border p-20 p-md-30">
                    <div class="row">
                        ...
                        @if(hasPermission('students.courses') || hasPermission('students.certificates') || hasPermission('students.payments') || hasPermission('students.activity.logs') || hasPermission('students.instructors'))
                            <div class="col-xxl-9 col-lg-8 col-md-12">
                                <div
                                    ...
                                    <ul class="nav pb-12 mb-20" id="pills-tab" role="tablist">
                                        @if(hasPermission('students.courses'))
                                        ...
                                        @endif
                                        @if(hasPermission('students.certificates'))
                                            <li class="nav-item" role="presentation">
                                        ...
                                        {{--                                    </li>--}}
                                        @if(hasPermission('students.payments'))
                                            <li class="nav-item" role="presentation">
                                                <a href="{{ route('students.payments', $user->id) }}"
                                                   class="nav-link {{ request()->route()->getName() == 'students.payments' ? 'active' : '' }}"
                                                   id="payments">{{ __('payment_history') }}</a>
                                            </li>
                                        @endif
                                        @if(hasPermission('students.activity.logs'))
                                            <li class="nav-item" role="presentation">
                                                <a href="{{ route('students.activity.logs', $user->id) }}"

                ...
                <div class="header-left">
                    <div class="brand-logo">
                        ...
                        @else
                            ...
                            <a href="{{ route('home') }}" class="sticky-logo">
                                <img
                                    src="{{ (setting('dark_logo') && @is_file_exists(setting('dark_logo')['original_image']) ? get_media(setting('dark_logo')['original_image']) : get_media('pak-dev/images/logo/pic2.svg')) }}"
                                    alt="logo">
                            </a>
                        @endif
                    </div>

...
<head>
    ...
    <meta name="author" content="SpaOrange">

    <title>Skolr AI | Installation</title>

    <link rel="shortcut icon" href="{{ static_asset('pak-dev/images/logo/pic2.svg') }}">
    ...
    <!--====== Color CSS ======-->
    <link rel="stylesheet" href="{{ static_asset('frontend/css/theme/orange.css') }}">
</head>
        ...
        <div class="panel panel-install">
            <div class="panel-heading text-center">
                @if (config('app.mobile_mode') == 'on')
                    <h2>Installation | Skolr AI - Flutter LMS App</h2>
                @else
                    <h2>Installation | Skolr AI LMS</h2>
                @endif

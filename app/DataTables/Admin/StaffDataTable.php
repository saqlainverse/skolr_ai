    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('status', function ($user) {
                return view('backend.admin.org_staff.status', compact('user'));
            })->addColumn('action', function ($user) {
                return view('backend.admin.org_staff.action', compact('user'));
            })->addColumn('name', function ($user) {
                return view('backend.admin.org_staff.name', compact('user'));
    ...
    public function query(): QueryBuilder
    {
        ...
        return User::with('organizationStaff', 'lastActivity')
            ...
            ->whereHas('organizationStaff', function ($query) {
                $query->where('organization_id', $this->org_id);
            })
